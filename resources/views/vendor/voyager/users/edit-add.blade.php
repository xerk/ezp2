                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            @php
                            if (isset($dataTypeContent->user_type)) {
                                $selected_user_type = $dataTypeContent->user_type;
                            } else {
                            ...
                            <div class="form-group">
                                <label for="default_role">{{ __('Cities') }}</label>
                                @php
                                    $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};
                                    $row     = $dataTypeRows->where('field', 'user_belongsto_city_relationship')->first();
                                    $options = $row->details;
                                @endphp
